  ...
  <UCard>
    <template #header>
      ...
      <p class="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-400">
        Suas informações pessoais não são compartilhadas com ninguém.
      </p>
    </template>
    <UForm
    ...
    >
        ...
        <UFormGroup label="Avatar" size="lg" name="avatarUrl">
          <div class="flex items-center gap-4">
            <UAvatar
              ...
              :alt="user.name"
            />
            <UButton @click="open" type="button" label="Alterar" color="white" />
          </div>
        </UFormGroup>
      </div>
      ...
      <UFormGroup label="Nome completo" size="lg" name="name">
        <UInput placeholder="Nome completo" v-model="state.name" />
      </UFormGroup>
      <div>
        <UButton
          :loading="loading"
